...
int AESEncrypt::getSBoxValue(int num)
{
	int sbox[256] = {
...
int AESEncrypt::getRcon(int num)
{
	int rcon[255] = {
...
void AESEncrypt::encryptStep(string subStr)
{
	int i;
	nr = 128;
	nk = nr / 32;
...
void AESEncrypt::encrypt()
{
	...
	for (int i = 0; i <= plainText.size() / 16; i++)
		encryptStep(plainText.substr(i * 16, 16*(i +1)));
